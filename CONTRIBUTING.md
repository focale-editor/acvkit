# Contributing to AcvKit

Thanks for helping improve AcvKit. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/acvkit/issues) before opening a new one.
...
AcvKit follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Dart SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/acvkit.git
cd acvkit
dart pub get
```
